    ...
    T: mq::Operations<RequestData = NvmeRequest>,
{
    pub(crate) fn try_new(
        ...
        let cq = dma::CoherentAllocator::alloc_coherent::<NvmeCompletion>(dev.as_ref().into(), depth.into(), flags::GFP_KERNEL)?;
        let sq = dma::CoherentAllocator::alloc_coherent(dev.as_ref().into(), depth.into(), flags::GFP_KERNEL)?;
