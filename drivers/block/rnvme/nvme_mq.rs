...
use kernel::types::URef;
use kernel::types::UniqueRefCounted;
use nvme_prp::*;
    ...
    T: mq::Operations<RequestData = NvmeRequest>,
{
    ...
    let rq = UniqueRefCounted::try_shared_to_unique(rq)
        .map_err(|_e| kernel::error::code::EIO)
        .expect("Failed to get unique reference\n");
