...
use crate::{
    ...
    block::mq::Operations,
    error::Result,
    time::hrtimer::{HasHrTimer, HrTimer, HrTimerCallback, HrTimerHandle, HrTimerPointer},
    time::Ktime,
    ...
    T::RequestData: HasHrTimer<T::RequestData>,
{
    fn cancel(&mut self) -> bool {
        ...
        let timer_ptr = unsafe { <T::RequestData as HasHrTimer<T::RequestData>>::raw_get_timer(request_data_ptr) };
