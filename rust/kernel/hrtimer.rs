...
//! ```
//! use kernel::{
//!     hrtimer::{Timer, TimerCallback, TimerMode, TimerPointer, TimerRestart},
...
//!         try_pin_init!(Self {
//!             timer <- Timer::new(TimerMode::Relative),
//!             flag <- new_mutex!(0),
//!             cond <- new_condvar!(),
//!         })
//!     }
...
//! ```
//! use kernel::{
//!     hrtimer::{Timer, TimerCallback, TimerMode, ScopedTimerPointer, TimerRestart},
//!     impl_has_timer, new_condvar, new_mutex,
//!     prelude::*,
//!     stack_try_pin_init,
//!     sync::{CondVar, Mutex},
...
pub use closure::start_function;
